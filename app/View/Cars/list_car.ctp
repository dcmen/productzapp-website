...
<div class="panel">
    ...
    <div class="panel-heading" style="overflow: hidden">
        <div class="col-xs-12 no-padding">
            <form action="<?php echo $this->Html->Url('/list_car')?>" method="get">
                ...
                <div class="col-md-2" style="padding: 0px 0px 0px 4px;;">
                    ...
                    <select name="filter" class="form-control type auto-submit">
                        ...
                        <option value="1" <?php echo ($filter == 1)?'selected':''?>>No Images Cars</option>
                        <option value="2" <?php echo ($filter == 2)?'selected':''?>>No VIN Cars</option>
                        <option value="3" <?php echo ($filter == 3)?'selected':''?>>Display Cars</option>
                        <option value="4" <?php echo ($filter == 4)?'selected':''?>>Hidden Cars</option>
                    </select>
                </div>
                ...
                <tbody class="body-list-car">
                    <?php if ($list) : ?>
                        ...
                        <tr>
                            ...
                            <td class="status-<?php echo $rs->cars->_id ?>">
                                <?php
                                $status = 0; // 0 - display, 1 - hidden, 2 - sold
                                if ($rs->cars->is_sold == 1) {
                                    $status = 2;
                                    echo 'Sold';
                                }
                                else if ($rs->cars->is_active == 2 || $rs->cars->is_showing == 0) {
                                    $status = 1;
                                    echo 'Hidden';
                                }
                                else {
                            ...
                            <td>
                                <a title="Edit car detail" href="<?php echo $this->Html->Url('/edit_car/'.$rs->cars->_id)?>"><i class="fa fa-edit"></i></a>
                                <a title="View car detail" href="<?php echo $this->Html->Url('/view_car/'.$rs->cars->_id)?>"><i class="fa fa-car"></i></a>
                                <?php if ($status != 2) : ?>
                                <a data-car-id="<?php echo $rs->cars->_id ?>" class="checker-show-car <?php echo ($status == 0)? 'hide-car' : 'show-car' ?>" href="javascript:;" style="outline: 0;">
                                    <i title="Unhide car" class="fa fa-eye"></i>
                                    <i title="Hide car" class="fa fa-eye-slash"></i>
                                </a>
                                <?php endif; ?>
                            </td>
                        </tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="FormSettingViewCar" action="<?php echo $this->Html->Url('/cars/set_display_car')?>" method="POST">
                        ...
                        <div class="checkbox" style="margin: 0px 10px 10px;">
                        ...
                        <div class="checkbox" style="margin: 0px 10px 20px;">
                            <label><input class="input-show" type="checkbox" name="no_year_showing" value="1" <?php echo ($showing && !$showing->year_showing) ? 'checked' : '' ?> >Hide if no YearOfManu</label>
                        </div>
