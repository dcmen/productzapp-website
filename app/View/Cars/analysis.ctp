<div class="main-page">
    <?php echo $this->element('cz_menu_bar_analysis', ['my_stock' => 1]); ?>
    ...
    <div class="pd-content-04">
        <div id="listCars">
            ...
            <?php if ($list) : ?>
                <?php echo $this->element('cz_cars_list', array('list' => $list, 'view_type' => 3)); ?>
            <?php else : ?>
...
<script>
    ...
    $(document).ready(function () {
        initPagination(maxPage, curPage, maxVisible = 5, url = 'analysis', container = '#listCars');
