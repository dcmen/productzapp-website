<div class="panel">
    <div class="panel-heading" style="overflow: hidden">
        <div class="col-xs-6"><h3 class="panel-title">User`s pulses</h3></div>
        <div class="col-xs-6 text-right">
            <a href="<?php echo $this->Html->Url('/admin_pulse')?>" class="btn btn-primary">Back</a>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('.pagecars').bootpag({
            ...
            load_show();
            $.get(root + "admin_pulse_user/<?php echo $id?>", dataString , function( data ) {
