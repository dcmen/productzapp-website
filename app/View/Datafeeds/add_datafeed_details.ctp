<div class="panel">
    <div class="panel-body">
        <div id="AdminDatafeed" class="col-md-8">
            <form id="AddDatafeed" action="<?php echo $this->Html->Url('/store_datafeed_details')?>" method="post">
                ...
                <div class="content_pulse">
                    ...
                    <div class="col-xs-12 col-lg-offset-5">
                        ...
                        <a href="<?php echo $this->Html->Url('/admin_datafeed_detail?id='.$id)?>" class="btn btn-view col-xs-12 col-md-2">Cancel</a>
                    </div>
                </div>    
