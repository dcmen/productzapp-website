...
$(document).ready(function(){
    ...
    $('.delete_record').click(function() {
        link = $(this).attr('href');
        if(link !=''){
            jConfirm('Are you sure you want to delete this selection.<br />Choose <b>OK</b> Or <b>Cancel</b>','Messages',function(r) {
                if(r){
