...
$add.SliderObj = function(settings){
  ...
  this.renderer = function(){
    ...
    if(!this._settings.range){
      var $handle = $("<div class='addui-slider-handle'><div class='addui-slider-value noselect'><span style='font-size: "+this._settings.fontsize+"px'></span></div></div>").appendTo($track);
      ...
      var $handle1 = $("<div class='addui-slider-handle addui-slider-handle-l'><div class='addui-slider-value noselect'><span style='font-size: "+this._settings.fontsize+"px'></span></div></div>").appendTo($track);
      ...
      function dragHandler1(e){
        ...
        // fix @KB
        offsetl = $('.addui-slider-handle-l').offset();
        offseth = $('.addui-slider-handle-h').offset();
          if ((offseth.left - offsetl.left) <= 62 && (offseth.left - offsetl.left) >= 30) {
            $('.addui-slider-handle-l > .addui-slider-value').css('top', '-20px');
            $('.addui-slider-handle-h > .addui-slider-value').css('top', '25px');
        }
        else if((offseth.left - offsetl.left) < 30) {
            //$('.addui-slider-handle-l > .addui-slider-value').css('margin-left', '-45px');
            //$('.addui-slider-handle-h > .addui-slider-value').css('margin-left', '9px');
            $('.addui-slider-handle-l > .addui-slider-value').css('top', '-20px');
            $('.addui-slider-handle-h > .addui-slider-value').css('top', '25px');
        }
        else {
            //$('.addui-slider-handle-l > .addui-slider-value').css('margin-left', '-20px');
            //$('.addui-slider-handle-h > .addui-slider-value').css('margin-left', '-33px');
            $('.addui-slider-handle-l > .addui-slider-value').css('top', '-20px');
            $('.addui-slider-handle-h > .addui-slider-value').css('top', '-20px');
        }
      };
      ...
      var $handle2 = $("<div class='addui-slider-handle addui-slider-handle-h'><div class='addui-slider-value noselect'><span style='font-size: "+this._settings.fontsize+"px'></span></div></div>").appendTo($track);
      ...
      function dragHandler2(e){
        ...
        if ((offseth.left - offsetl.left) <= 62 && (offseth.left - offsetl.left) >= 30) {
            $('.addui-slider-handle-l > .addui-slider-value').css('top', '25px');
            $('.addui-slider-handle-h > .addui-slider-value').css('top', '-20px');
            //$('.addui-slider-handle-l > .addui-slider-value').css('margin-left', '-33px');
            //$('.addui-slider-handle-h > .addui-slider-value').css('margin-left', '-5px');
        }
        else if((offseth.left - offsetl.left) < 30) {
            $('.addui-slider-handle-l > .addui-slider-value').css('top', '25px');
            $('.addui-slider-handle-h > .addui-slider-value').css('top', '-20px');
