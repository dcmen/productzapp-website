...
//        photo = $("input[type='photo']").val();
//    $.post(root + 'users/upload',{'photo':photo},function(data){
//       if(data.error == 1){
//            alert('ddd');
//       } 
//    },'json');
